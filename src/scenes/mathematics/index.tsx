      ...
      <div className='mx-20 my-32'>
        ...
        <div className="flex items-center my-8">
          ...
          <div className="flex items-center justify-center">
            <a href='https://academicworks.cuny.edu/gc_etds/2030/' className="text-center font-bold">Dissertation: "Rewriting Methods in Groups with Applications to Cryptography"</a>
          </div>
        </div>
      </div>
    );
